   ...
   var homeLatlng = new google.maps.LatLng(lat, lng); //set default coordinates
    var homeMarker = new google.maps.Marker({ //set marker
      ...
      icon: "https://hey.engineershub.co/themes/ehthree/assets/maps/markers.png",
      width: '10px',
      height: '10px',
	  zoom: 17
    });
  ...
  if (homeMarker.getAnimation() != null) {
    ...
    var myOptions = {
      center: new google.maps.LatLng(30.038664259267904, -11.671873927116394), //set map center
      zoom: 2, //set zoom level to 17
    ...
    google.maps.event.addListener(homeMarker, 'position_changed', toggleBounce, function(){
    ...
    var input = document.getElementById('autocomplete'); //get element to use as input for autocomplete
